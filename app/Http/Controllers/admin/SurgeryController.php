...
class SurgeryController extends Controller
{
    public function List()
    {
        ...
        return view('admin.surgery.List', compact('surgeries'));
    }
    public function create()
    {
        ...
        return view('admin.surgery.create', compact('insurances', 'surgeons', 'anesthesiologists', 'consultants', 'operations', 'today'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.Surgery.Edit', compact('surgery', 'insurances', 'surgeons', 'anesthesiologists', 'consultants', 'operations', 'surgeried_at', 'released_at'));
    }

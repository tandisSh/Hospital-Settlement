            ...
            <div class="col-md-8 col-lg-6">
                <div class="card card-primary card-outline mb-4 shadow-sm">
                    <div class="card-header bg-primary text-white d-flex justify-content-center align-items-center">
                        <h3 class="card-title mb-0">افزودن بیمه جدید</h3>
                    </div>

                    <form action="{{ route('insurances.store') }}" method="POST" class="needs-validation" novalidate>
                        @csrf
                        <div class="card-body">
                            <div class="mb-3 row">
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-9">
                                    <select name="type" class="form-control form-control-lg @error('type') is-invalid @enderror" 
                                        ...
                                        <option value="supplementary" {{ old('type') == 'supplementary' ? 'selected' : '' }}>تکمیلی</option>
                                    </select>
                                    @error('type')
                                        <div class="invalid-feedback d-block">
                                            {{ $message }}
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-9">
                                    <input name="discount" type="number" class="form-control form-control-lg @error('discount') is-invalid @enderror"
                                        id="discount" min="0" max="100" value="{{ old('discount') }}" required />
                                    @error('discount')
                                        <div class="invalid-feedback d-block">
                                            {{ $message }}
                                        </div>
                        ...
                        <div class="card-footer bg-light d-flex justify-content-center">
                            <button type="submit" class="btn btn-primary btn-lg">ثبت بیمه</button>
                        </div>
                    </form>
                </div>
            </div>

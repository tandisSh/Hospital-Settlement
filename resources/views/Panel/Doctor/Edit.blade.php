                        ...
                        <div class="card-body">
                            <div class="row g-2">
                                ...
                                <div class="col-12">
                                    ...
                                    <select name="speciality_id" class="form-control form-control-sm @error('speciality_id') is-invalid @enderror"
                                        required>
                                ...
                                <div class="col-6">
                                    ...
                                    <select name="status" class="form-control form-control-sm @error('status') is-invalid @enderror"
                                        ...
                                        <option value="0" {{ old('status', $doctor->status) == '0' ? 'selected' : '' }}>غیرفعال</option>
                                    </select>
                                    @error('status')
                                        <div class="invalid-feedback">
                                            {{ $message }}

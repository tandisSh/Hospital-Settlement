    ...
    <div class="container-fluid">
        <div class="row justify-content-center">
                    ...
                    <table class="table table-bordered table-sm">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ \Morilog\Jalali\Jalalian::fromDateTime($item->surgeried_at)->format('Y/m/d') }}</td>
                                <td>{{ \Morilog\Jalali\Jalalian::fromDateTime($item->released_at)->format('Y/m/d') }}</td>
                ...
                <div class="d-flex justify-content-center mt-4 no-print">
                    ...
                    <a href="{{ route('Panel.InvoiceList') }}" class="btn btn-secondary">

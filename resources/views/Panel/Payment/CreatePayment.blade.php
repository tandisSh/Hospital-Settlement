                    ...
                    <div class="card-body">
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane fade show active" id="cash" role="tabpanel">
                                <form method="POST" action="{{ route('Panel.StoreCashPayment') }}" enctype="multipart/form-data" id="cashForm">
                                    @csrf
                            ...
                            <div class="tab-pane fade" id="cheque" role="tabpanel">
                                <form method="POST" action="{{ route('Panel.StoreChequePayment') }}" enctype="multipart/form-data" id="chequeForm">
                                    @csrf
                                    <input type="hidden" name="invoice_id" value="{{ $invoice->id }}">
